  ...
  return (
    <div className="main-page">
      <div className="main-page-container">
        ...
        <p>
          In this game, you will have 30 seconds to memorize the positions of the cards on the right side (Spades). After the 30 seconds, the set of cards on the right will turn over, and you will need to match the pairs (by dragging and dropping) with the cards on the left (Diamonds) based on your memory. The cards on the left will stay open. 
          <br />
          <br />
